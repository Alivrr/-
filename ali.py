...
def kontrol(cookie,token):
    ...
    if res1.json()["benefitCode"]=="SALLA_TOPLA1":
        ...
        print("ÜZGÜNÜM, ZATEN SALLA TOPLA YAPMIŞSIN...")
        return False
...
puan(cookie,token)
logout(cookie,token)
print("edit:@Ali-TEKNOGAM AİLESİNE SELAMLAR...not kod bana ait değildir sadece gerekli gördüğüm yerleri editledim.")time.sleep(8)
